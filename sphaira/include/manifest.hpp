...
constexpr const char* DISABLED_COMPONENTS_PATH = "/config/sphaira/disabled-components.json";
constexpr const char* DISABLED_COMPONENTS_DIR = "/config/sphaira/disabled-components";
