...
.list .item{display:flex;align-items:center;gap:16px;padding:12px 16px;background:#1e1e24;border:1px solid rgba(255,255,255,0.05);border-radius:8px;color:inherit;text-decoration:none;transition:background 0.15s,transform 0.15s}
...
.grid .item{display:flex;flex-direction:column;background:#18181f;border:1px solid rgba(255,255,255,0.05);border-radius:12px;color:inherit;text-decoration:none;overflow:hidden;transition:all 0.2s}
