...
- [x] BUILD-RELEASE — Release NRO зібрано; i18n JSON і `git diff --check` пройдено
- [ ] HW-SMOKE-238 — ручний smoke test на реальній Switch за `tests.md`
...
- [ ] HIST-61A — Games: Game Details з Overview/Components/Tickets/Saves
  ...
  - [ ] Вкладки Tickets і Saves, повний список мов та фактичні save usage
...
- [ ] HIST-62 — Games: badges Base/Update/DLC/LayeredFS
...
`HIST-61A`: Tickets/Saves, повний список мов і фактичний save usage.
