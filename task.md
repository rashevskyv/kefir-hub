# Список завдань: Контекстне меню джерел, тестування з'єднання, копіювання URL, синхронізація джерел та збереження позиції курсору (v0.13.233)
...
- [x] **Реалізація змін**:
  ...
  - [x] Ітерувати версію програми до `0.13.233` у `sphaira/CMakeLists.txt`
- [x] **Верифікація**:
