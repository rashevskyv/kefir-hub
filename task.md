# Список завдань: Контекстне меню джерел, тестування з'єднання, копіювання URL та синхронізація джерел (v0.13.232)
...
- [x] **Реалізація змін**:
  ...
  - [x] Ітерувати версію програми до `0.13.232` у `sphaira/CMakeLists.txt`
- [x] **Верифікація**:
