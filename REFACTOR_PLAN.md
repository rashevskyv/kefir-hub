...
| 1.3 | `cheats/cheats_db.hpp/.cpp` | `CachedCheatMetadata` (~1587), `NxDbVersionInfo` (~1902) and helpers for the cheat DB / cache / download-side metadata. |
