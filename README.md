...
- **Tools Menu Integration:** Press **Start** (or **X**) in the console's **Tools** menu to open the Network Server context menu. It allows you to quickly launch the **Web Server** (sharing the SD Card root `/`) or the **Screenshots** gallery (redirecting the browser directly to `/album`).
